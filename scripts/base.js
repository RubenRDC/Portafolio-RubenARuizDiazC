...
function loadProject(Project) {
    ...
    document.getElementById("previewProject").addEventListener("click", (e) => { if (e.target.id == "previewProject" || e.target.id == "close_previewProject") { closePreview(); } });
}
