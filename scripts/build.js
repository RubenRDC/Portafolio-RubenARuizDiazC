...
function loadProject(Project){let string=`<section id="previewProject">
        ...
        </section>`;content.insertAdjacentHTML("beforeend",string);document.getElementById("close_previewProject").addEventListener("click",closePreview);document.getElementById("previewProject").addEventListener("click",(e)=>{if(e.target.id=="previewProject"){closePreview(e)}});html.classList.add("offScroll")}
